...
export const CREATURES = {
  ...
  // the player's on-screen avatar for the parachute cinematic — a proper heroic warrior (KayKit Barbarian)
  warrior: new RiggedAsset("/models/creatures/barbarian.glb", 2.3),
};
